...
UIButton homeMenuTheme;
UIButton homeMenuLanguage;
...
void loadUIElements(){
  ...
  homeMenuEditor         = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_BACKGROUND_COL, THEME_UNAVAILABLE_COL, THEME_UNAVAILABLE_COL, THEME_UNAVAILABLE_COL, THEME_UNAVAILABLE_COL, localisation.getString("UI_BUTTON_EDITOR"));  
  y += inc;
  homeMenuProject        = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_HIGHLIGHT_COL, THEME_HIGHLIGHT_COL, THEME_FOREGROUND_COL, THEME_FOREGROUND_COL, THEME_BACKGROUND_COL, localisation.getString("UI_BUTTON_PROJECTS"));  
  y += inc;
  homeMenuDocumentation  = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_HIGHLIGHT_COL, THEME_HIGHLIGHT_COL, THEME_FOREGROUND_COL, THEME_FOREGROUND_COL, THEME_BACKGROUND_COL, localisation.getString("UI_BUTTON_DOCUMENTATION"));  
  y += (inc*1.3);
  homeMenuTheme          = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_HIGHLIGHT_COL, THEME_HIGHLIGHT_COL, THEME_FOREGROUND_COL, THEME_FOREGROUND_COL, THEME_BACKGROUND_COL, localisation.getString("UI_BUTTON_THEMES"));  
  y += inc;
  homeMenuLanguage       = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_HIGHLIGHT_COL, THEME_HIGHLIGHT_COL, THEME_FOREGROUND_COL, THEME_FOREGROUND_COL, THEME_BACKGROUND_COL, localisation.getString("UI_BUTTON_LANGUAGE"));  
  y += (inc*1.3);
  homeMenuExit           = new UIButton(350, 45, (width/2) - (350/2), y, 2, THEME_BACKGROUND_COL, THEME_HIGHLIGHT_COL, THEME_HIGHLIGHT_COL, THEME_FOREGROUND_COL, THEME_FOREGROUND_COL, THEME_BACKGROUND_COL, localisation.getString("UI_BUTTON_EXIT"));
...
void homePage(){
  ...
  if(homeMenuTheme.handle()){
    scene = SCENE_THEME;  
  }
  
  if(homeMenuLanguage.handle()){
